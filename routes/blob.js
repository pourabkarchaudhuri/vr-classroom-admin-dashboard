...
router.get('/',
  async function(req, res) {
    ...
    // var name = process.env.AZURE_STORAGE_ACCOUNT;

    // req.cookies.accountName = name;
    // req.cookies.accountKey = key;
      if(!req.isAuthenticated()){
           // Redirect unauthenticated requests to home page
        res.redirect('/')
      }
      else{
        res.sendFile(path.join(path.resolve(__dirname, '..'), 'client', 'blob.html'))
        // res.sendFile('D:/shubham/azure-storage-web/azure-storage-https/vr-classroom-admin-dashboard/client/blob.html')
      }
